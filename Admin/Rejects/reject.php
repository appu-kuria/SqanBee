...
<html>
    <head>
        <title>Dashboard<?php echo $_SESSION['user_id']  ?></title>
            ...
            <div>
                ...
                <ul class="side-nav">
                    ...
                    <!-- <li class="side-nav__item">
                        ...
                        <span>Add a new Hotel Brand</span>
                    </li>
                    <li class="side-nav__item">
                        <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span>Update?Delete Existing Brand</span>
                    </li>
                    <li class="side-nav__item">
                        <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="bottom-container__left">
                    ...
                    <div class="box total-box">
                        <div class="total-box__left">
                            ...
                            <!-- <h1 class="price">50,530<span class="price-currency">(USD)</span></h1> -->
